...
| `cook dub <stage> <root> <name> --python <venv>` | Dub pipeline (separate/reference/synth/timeline/retime/burn, or `full`) under the IndexTTS2 venv; `burn --keep-subs` reuses hand-edited subtitle files | video-dubbing Steps 1-7 |
